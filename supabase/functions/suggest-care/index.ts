...
${imageBefore ? "사진이 두 장입니다. 첫 번째가 케어 전, 두 번째가 케어 후입니다. 케어 전 사진에서 눈에 띄는 문제(사인펜·잉크·음식물·황변 같은 얼룩과 자국, 변색, 구김, 눌린 볼륨, 흐려진 색감 등)를 먼저 찾고, 케어 후 사진에서 그것이 어떻게 됐는지 확인하세요. 위치까지 구체적으로(예: 왼쪽 가슴, 소매 끝, 앞판 중앙)." : "사진은 케어가 끝난 완성품 한 장입니다."}
...
${imageBefore ? "- 첫 문장은 반드시 '케어 전에 무엇이 있었고, 케어 후 어떻게 됐는지'를 사실대로 씁니다. 예: '왼쪽 가슴의 보라색 사인펜 자국이 말끔히 제거되었습니다.' / '앞판의 누런 변색이 사라지고 흰색이 되살아났습니다.' 이 문장에서는 얼룩·자국·변색 같은 단어를 써도 됩니다(제거됐다는 사실을 전하는 것이므로). 단, 원인을 추측하거나 고객을 탓하는 표현은 금지. 뭉뚱그린 말('깨끗해졌습니다')만으로 때우지 마세요. 두 번째 문장은 소재 특성에 맞춘 집중 케어를 정성껏 마쳤다는 내용. 만약 두 사진에서 차이를 정말 못 찾겠으면 색감·형태가 정돈되었다는 정도로만 쓰세요." : "- 이 품목의 소재·특성에 맞춰 '집중 케어'를 정성껏 마쳤다는 내용. 어떤 부분(충전재·볼륨·갑피·가죽결·시트·벨트 등)을 신경 썼는지 언급하면 좋습니다."}
...
- 브랜드명이 확실할 때만 자연스럽게 언급. ${imageBefore ? "" : "얼룩·손상·오염 같은 부정적 표현은 쓰지 마세요(이미 케어 완료된 상태입니다)."}
